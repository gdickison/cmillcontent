    ...
    <div className="creative-stagePlaysContentCard">
      <div className="creative-stagePlaysContentGrid">
        <div className="creative-stagePlaysContentCardContents">
          <p className="creative-stagePlaysTitle">
            {title}
          </p>
          <p className="creative-stagePlaysGenre">
            {genre}
          </p>
        </div>
        <div className="creative-stagePlaysContentCardContents">
          <div className="creative-stagePlaysDescription">
            {description}
          </div>
        </div>
        <div className="creative-stagePlaysContentCardContents">
          <p className="creative-stagePlaysPerformance">
            {performance}
          </p>
        </div>
        {link &&
